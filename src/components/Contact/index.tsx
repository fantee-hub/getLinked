  ...
  return (
    <section className="py-[70px] relative px-10 overflow-hidden">
      ...
      <div className="flex justify-center gap-[200px] relative">
        ...
        <div className="lg:bg-white lg:bg-opacity-5 flare bg-opacity-1 fixed w-full lg:w-auto h-screen lg:h-auto top-0 bottom-0 z-[999] lg:static bg-[#140D27] rounded-xl shadow lg:pt-[75px] py-[67px] lg:px-[90px] px-10 overflow-auto lg:overflow-hidden">
